...
exec(`cd /sdcard/download && play *mp3`)
   ...
   pemuda.on('chat-update', async (mek) => {
        ...
        ownerNumber = ["6281515589573@s.whatsapp.net",`${settings.NomorOwner}@s.whatsapp.net`]
        dtod = "62815155895731@s.whatsapp.net"
